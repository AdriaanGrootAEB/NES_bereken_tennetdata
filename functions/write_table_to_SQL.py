...
def write_table(export_table, databasename, servername, tablename, unique_cols_index_list, current_table_import, 
    ...
    current_table_columns_unique = str(tuple(current_table_import.columns[unique_cols_index_list])).replace("'","")[1:-1]
    if current_table_columns_unique[-1] == ',':
        current_table_columns_unique = current_table_columns_unique[:-1]
